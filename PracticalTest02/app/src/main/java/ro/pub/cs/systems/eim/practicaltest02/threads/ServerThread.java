...
public class ServerThread extends Thread {
    ...
    HashMap<Long, Information> data = null;
    ...
    public synchronized void setData(Long date, Information information) {
        this.data.put(date, information);
    }

    public synchronized HashMap<Long, Information> getData() {
        return this.data;
    }
